...
<body>
    ...
    <div class="wrapper">
        ...
        if(isset($_POST['submit'])){
            if(isset($_FILES['foto'])){
                ...
                if($file_tmp == null){
                    $foto = $data['foto'];
                    $script = "UPDATE baju SET judul='$judul', harga=$harga, asal='$asal', deskripsi='$deskripsi',
                    nama='$nama', telp='$telp', foto='$foto' where id= $id";
                } else{
    ...
    <input type="number" clas="form-control" name="telp" value="0<?=$data['telp']?>">
    </div>
